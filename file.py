...
sports_directory['soccer'][0] ='Andres' #if it's dictionary i can just call the key then the index
...
print(sports_directory['soccer']) #once change i can print sports with the key 
...
# list and prints each key and the associated value. 
